...
select department_id as "부서ID", format(avg(salary),0)as "급여평균"
from employees
...
-- ex7) having절 (where + group by + having)
...
-- ex9) cross join: 모든행에 대해 가능한 모든 조합을 생성하는 조인
